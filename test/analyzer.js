...
describe('Analyzer', function () {
  ...
  it('should expose names of parent chunk assets for code-split chunks', async function () {
    // Test using build stats from the code splitting example at https://git.io/fhiTe
    generateReportFrom('with-code-splitting.json');
    const chartData = await getChartData();
